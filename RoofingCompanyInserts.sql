...
insert into Contract(StartDate, EndDate, Salary, IdEmployee, IdPosition, HealTestDate, WorkplaceTrainingDate)
	values
		...
		('2018-03-22', '2019-03-22', 5000, 21, 5, '2018-03-20', '2018-03-23');
...
insert into Absence(IdAbsenceType, IdEmployee, StartOfAbsence, EndOfAbsence)
	values
		...
		(1, 6, '2019-04-12', '2019-04-19'),
		(2, 12, '2019-04-01', '2019-04-08'),
		(2, 1, '2019-04-21', '2019-04-22'),
		(2, 2, '2019-04-02', '2019-04-02'),
		(1, 3, '2019-04-15', '2019-04-20'),
		(1, 4, '2019-04-12', '2019-04-19'),
		(1, 5, '2019-04-01', '2019-04-08'),
		(2, 6, '2019-04-21', '2019-04-22'),
		(2, 11, '2019-05-02', '2019-05-08');
...
insert into Payment(Bonus, IdEmployee, Date, Sum)
	values
		...
		(325, 2, '2018-12-01', 2865),
		(350, 3, '2019-01-01', 3450),
		(450, 4, '2019-01-01', 3350),
		(default, 5, '2019-01-01', 4100),
		(default, 6, '2019-02-01', 3560),
		(120, 7, '2019-02-01', 3420),
		(170, 8, '2019-02-01', 4420);
...
INSERT INTO Contractor(ContractorName,Phone,Email,City,PostalCode,Street,HouseNumber,ApartmentNumber,NIP,KRS)
	values
		...
		('NC+', 222200000, 'nc+@canal+.pl', 'Łódź', 31535, 'al. gen. W. Sikorskiego', '12', '2', 5210082774, 0000469644);
...
insert into Training(IdEmployee, TrainingName, TrainingStartDate, TrainingEndDate, TrainingPrice)
	values 
		...
		(8, 'Szkolenie WaterJetSystem', '2020-02-08', '2020-02-10', 1200),
		(9, 'Szloenie Sandvik', '2020-03-15', '2020-03-15', 600),
		(10, 'Szloenie Sandvik', '2020-03-15', '2020-03-15', 600),
		(11, 'Sympozjum "przemysł 4.0', '2020-04-22', '2020-04-22', 550),
		(13, 'MS Office', '2020-05-10', '2020-05-10', 1020),
		(17, 'MS Office', '2020-05-10', '2020-05-10', 1020),
		(18, 'MS Office', '2020-05-10', '2020-05-10', 1020),
		(19, 'Szkolenie - Nowoczesne pokrycia dachowe', '2020-07-10', '2020-07-11', 300),
		(21, 'Szkolenie - Nowoczesne pokrycia dachowe', '2020-07-10', '2020-07-11', 300),
		(22, 'Szkolenie - Nowoczesne pokrycia dachowe', '2020-07-10', '2020-07-11', 300);
